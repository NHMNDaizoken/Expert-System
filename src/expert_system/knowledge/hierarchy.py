"""
hierarchy — Build the 6-level automotive diagnosis hierarchy.

This module processes ontology, symptoms, and rules to generate
a hierarchical tree of systems, symptoms, and procedures.
"""
...
@dataclass
class HierarchyNode:
    """Represents a node in the expert system diagnostic hierarchy."""
    id: str
    level: int
    type: str
    name: str
